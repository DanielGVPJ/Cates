...
void EnviaSMS(){              
 ...
 mySerial.println("AT+CMGS=\"+522287774859\"");  // Definimos el numero del destinatario en formato internacional
 delay(100);                                    // Pequeña pausa
 mySerial.print("Bienvenido a Livion (Prueba exitosa)");                 // Definimos el cuerpo del mensaje
